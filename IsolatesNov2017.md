...
```bash
  ...
  for RawData in $(ls raw_dna/paired/*/Ag05/*/*.fastq.gz); do
	  echo $RawData;
...
```bash
	Read_F=raw_dna/paired/N.ditissima/IsolatesNov2017/ND8/F/*.fastq.gz
	Read_R=raw_dna/paired/N.ditissima/IsolatesNov2017/ND8/R/*.fastq.gz
  ...
  Read_F=raw_dna/paired/N.ditissima/IsolatesNov2017/Ag02/F/*.fastq.gz
	Read_R=raw_dna/paired/N.ditissima/IsolatesNov2017/Ag02/R/*.fastq.gz
	IluminaAdapters=/home/gomeza/git_repos/emr_repos/tools/seq_tools/illumina_full_adapters.fa
	ProgDir=/home/gomeza/git_repos/emr_repos/tools/seq_tools/rna_qc
	qsub $ProgDir/rna_qc_fastq-mcf.sh $Read_F $Read_R $IluminaAdapters DNA

  Read_F=raw_dna/paired/N.ditissima/IsolatesNov2017/Ag05/F/*.fastq.gz
  Read_R=raw_dna/paired/N.ditissima/IsolatesNov2017/Ag05/R/*.fastq.gz
  IluminaAdapters=/home/gomeza/git_repos/emr_repos/tools/seq_tools/illumina_full_adapters.fa
  ProgDir=/home/gomeza/git_repos/emr_repos/tools/seq_tools/rna_qc
  qsub $ProgDir/rna_qc_fastq-mcf.sh $Read_F $Read_R $IluminaAdapters DNA

  Read_F=raw_dna/paired/N.ditissima/IsolatesNov2017/R37-15/F/*.fastq.gz
  Read_R=raw_dna/paired/N.ditissima/IsolatesNov2017/R37-15/R/*.fastq.gz
  IluminaAdapters=/home/gomeza/git_repos/emr_repos/tools/seq_tools/illumina_full_adapters.fa
  ProgDir=/home/gomeza/git_repos/emr_repos/tools/seq_tools/rna_qc
  qsub $ProgDir/rna_qc_fastq-mcf.sh $Read_F $Read_R $IluminaAdapters DNA
```
...
```bash
	for RawData in $(ls qc_dna/paired/*/ND8/*/*.fq.gz); do
	echo $RawData;
	ProgDir=/home/gomeza/git_repos/emr_repos/tools/seq_tools/dna_qc;
	qsub $ProgDir/run_fastqc.sh $RawData;
  done
...
```bash
  ...
  OutDir=qc_dna/kmc/N.ditissima/ND8/
	qsub $ProgDir/kmc_kmer_counting.sh $Trim_F $Trim_R $OutDir
```
...
```bash
	F_Read=qc_dna/paired/N.ditissima/IsolatesNov2017/ND8/F/*.fq.gz
	R_Read=qc_dna/paired/N.ditissima/IsolatesNov2017/ND8/R/*.fq.gz
	ProgDir=/home/gomeza/git_repos/emr_repos/tools/seq_tools/assemblers/spades
	Outdir=assembly/spades/N.ditissima/IsolatesNov2017/ND8/
	qsub $ProgDir/submit_SPAdes_HiMem.sh $F_Read $R_Read $Outdir correct

  F_Read=qc_dna/paired/N.ditissima/Ag02/F/*.fq.gz
	R_Read=qc_dna/paired/N.ditissima/Ag02/R/*.fq.gz
	ProgDir=/home/gomeza/git_repos/emr_repos/tools/seq_tools/assemblers/spades
	Outdir=assembly/spades/N.ditissima/IsolatesNov2017/Ag02/
	qsub $ProgDir/submit_SPAdes_HiMem.sh $F_Read $R_Read $Outdir correct

  F_Read=qc_dna/paired/N.ditissima/IsolatesNov2017/Ag05/F/*.fq.gz
  R_Read=qc_dna/paired/N.ditissima/IsolatesNov2017/Ag05/R/*.fq.gz
  ProgDir=/home/gomeza/git_repos/emr_repos/tools/seq_tools/assemblers/spades
  Outdir=assembly/spades/N.ditissima/IsolatesNov2017/Ag05/
  qsub $ProgDir/submit_SPAdes_HiMem.sh $F_Read $R_Read $Outdir correct

  F_Read=qc_dna/paired/N.ditissima/IsolatesNov2017/R37-15/F/*.fq.gz
  R_Read=qc_dna/paired/N.ditissima/IsolatesNov2017/R37-15/R/*.fq.gz
  ProgDir=/home/gomeza/git_repos/emr_repos/tools/seq_tools/assemblers/spades
  Outdir=assembly/spades/N.ditissima/IsolatesNov2017/R37-15/
  qsub $ProgDir/submit_SPAdes_HiMem.sh $F_Read $R_Read $Outdir correct
```
...
```bash
  ...
  for Assembly in $(ls assembly/spades/N.ditissima/IsolatesNov2017/ND8/filtered_contigs/contigs_min_500bp.fasta); do
