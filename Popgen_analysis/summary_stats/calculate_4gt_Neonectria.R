...
Neonectria <- c("Ag02", "Ag04", "Ag05", "Ag06", "Ag08", "Ag09_A", "Ag11_A", "Ag11_B", "Ag11_C", "BGV344", "ND8", "ND9", "Hg199", "OPC304", "P112", "R0905", "R37-15", "R39-15", "R41-15", "R42-15", "R45-15", "R6-17-2", "R6-17-3","R68-17-C2", "R68-17-C3", "SVK1", "SVK2","NMaj")

populations <- list(Neonectria)
population_names <- c(Neonectria)
