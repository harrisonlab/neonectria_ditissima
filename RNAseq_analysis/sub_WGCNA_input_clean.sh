...
scripts=/home/gomeza/git_repos/emr_repos/scripts/neonectria_ditissima/RNA_Seq_scripts

/home/gomeza/prog/R/R-3.2.5/bin/Rscript --vanilla $scripts/WGCNA_input_clean.R --gene_table $1 --out_dir $2
